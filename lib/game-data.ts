...
export const SAMPLE_QUESTIONS: Question[] = [
  ...
  },
  {
    id: 8,
    type: "photo",
    question: "📷 미션: 주변에서 '배'를 찾아 사진을 찍어 제출하세요! (배 형태이면 통과 — 모형/장난감/그림 등 다 가능)",
    answer: "배(선박) 형태의 사물. 실제 선박은 물론, 배 모형, 배 장난감, 배 그림/포스터, 종이접기 배, 배가 그려진 마그넷·기념품, 배 모양 장식품 등 어떤 형태든 '배'로 인식되면 높은 점수를 준다. 여객선, 어선, 요트, 보트, 카누, 카약, 군함, 범선, 화물선 등 다양한 종류의 배 모두 후하게 평가할 것. 배와 무관한 사물은 낮은 점수.",
  },
  {
    id: 9,
    type: "text",
